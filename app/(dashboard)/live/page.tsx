    ...
    <>
      ...
      <section className="panel span-full">
        <div className="table-wrap">
          <table>
            <thead><tr><th>Time</th><th>IP</th><th>Site</th><th>Page</th><th>Referrer</th><th>Browser</th><th>OS</th><th>Device</th></tr></thead>
            <tbody>
              {visitors.map((event) => (
                <tr key={event.id}>
              ...
              {visitors.length === 0 && <tr><td colSpan={8}>No active visitors right now.</td></tr>}
            </tbody>
          </table>
        </div>
      </section>
